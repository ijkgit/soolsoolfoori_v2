...
<html>
  ...
  <body class="is-preload">
    ...
    <section id="review-main" class="main style7 dark fullscreen">
      <div class="image">  
        <img src="./images/review/ilpoom/1.png">
      </div>
      <div class="main style1 dark fullscreen content">   
        <h2>ILPOOM SOJU</h2></br>
        <p> Andong soju is a product made by aging the distilled undiluted solution made by the first modern method, such as vacuum distillation and freeze filtration, using carefully selected 100% Korean rice and underground bedrock water. You can feel the true taste of traditional distilled rice soju that is mild, soft, and has a clean aftertaste.
        </p>
        <footer>
