...
<?php
	...
	$sql = "insert into board (email, name, title, content, regist_day, hit, file_name, file_type, file_copied, category, likeNum) ";
	$sql .= "values('$user', '$name', '$title', '$content', '$regist_day', 0, ";
	$sql .= "'$upfile_name', '$upfile_type', '$copied_file_name', '$category', 0)";
