...
<html>
  ...
  <body class="is-preload">
    ...
    <section id="review-main" class="main style7 dark fullscreen">
      <div class="image">  
        <img src="./images/review/sulsaem/1.png">
      </div>
      <div class="main style1 dark fullscreen content">   
        <h2>SULSAEM 16</h2></br>
        <p> Sulsaem, located in Yongin-si, Gyeonggi-do, took its first step in May 2013 with six members, including CEO Shin In-geon, at Gayangju Research Institute. Sulsaem uses all of Gyeonggi-mi new rice, bedrock water from underground, and yeast directly from the brewery under the idea that good ingredients and sincerity are the basics of making good alcohol.
        </p>
        <footer>
