...
<html>
  ...
  <body class="is-preload">
    ...
    <section id="review-main" class="main style7 dark fullscreen">
      <div class="image">  
        <img src="./images/review/taoyuan/1.png">
      </div>
      <div class="main style1 dark fullscreen content">   
        <h2>TAOYUAN RESOLUSTION</h2></br>
        <p> Yeongdeok Brewery manufactures alcohol in Yeongdeok-gun, a town with a refreshing blue sea, and if there is something slightly different from other breweries, it is made by adding turmeric, blueberry, deodeok, water parsley, etc. to the characteristics of makgeolli, namely the taste and fermented food We are making traditional liquor with an emphasis on the fact that our body likes it a little more than when we ate it.
        </p>
        <footer>
