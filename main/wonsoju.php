...
<html>
  ...
  <body class="is-preload">
    ...
    <section id="review-main" class="main style7 dark fullscreen">
      <div class="image">  
        <img src="./images/review/won/img_won_list_01.jpg">
      </div>
      <div class="main style1 dark fullscreen content">   
        <h2>WONSOJU</h2></br>
        <p> Wonsoju is made from Wonju rice totomi, a specialty of Wonju, Gangwon Province, cultivated around the Seom River in the upper reaches of the Namhan River. 
Made with only 100% rice, without any artificial sweeteners added. 
Wonsoju distilled only from rice has the advantage of subtly spreading the grain flavor of rice, and through the aging process, it has less bitterness unique to alcohol and boasts a clean and clean aftertaste.
        </p>
        <footer>
