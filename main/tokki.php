...
<html>
  ...
  <body class="is-preload">
    ...
    <section id="review-main" class="main style7 dark fullscreen">
      <div class="image">  
        <img src="./images/review/tokki/1.png">
      </div>
      <div class="main style1 dark fullscreen content">   
        <h2>TOKKI SOJU</h2></br>
        <p> The first soju created in the United States
Rabbit Soju was born in the hands of American CEO Bran Hill. After graduating from college, CEO Bran Hill, who worked at a beer consulting company, came to Korea at the end of 2010 and traveled to various breweries.
        </p>
        <footer>
