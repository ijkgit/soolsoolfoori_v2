...
<html>
  ...
  <body class="is-preload">
    ...
    <section id="review-main" class="main style7 dark fullscreen">
      <div class="image">  
        <img src="./images/review/daedaepo/one.jpg">
      </div>
      <div class="main style1 dark fullscreen content">   
        <h2>DAEDAEPO BLUE</h2></br>
        <p> Jukhyangdo is located in Damyang, where bamboo is beautiful, and produces local makgeolli that represents Damyang, Jeollanam-do. We want to inherit the spirit and spirit of the nation in makgeolli, Korea's representative folk liquor made from rice.
        </p>
        <footer>
